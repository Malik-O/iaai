...
// Routes
app.get("/", (req, res) => {
	res.json({ status: "success", message: "Venom Bot API is running" });
});
...
app.listen(port, async () => {
	console.log(`Venom Bot API server is running on port ${port}`);
	// Uncomment to auto-initialize on server start
	// await initVenom();
});
